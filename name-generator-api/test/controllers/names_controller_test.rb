...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { japanese: @name.japanese, roman_letter: @name.roman_letter, sex: @name.sex } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { japanese: @name.japanese, roman_letter: @name.roman_letter, sex: @name.sex } }
